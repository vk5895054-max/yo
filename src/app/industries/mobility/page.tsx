...
export default function MobilityPage() {
  ...
  const capabilities = [
    {
      title: "Connected Vehicle OS & Telematics",
      desc: "Architecting automotive Android Automotive OS & Linux firmware with CAN bus & OBD-II telemetry streaming.",
    },
    {
      title: "EV Charging Infrastructure (OCPP)",
      desc: "Building OCPP 2.0.1 compliant cloud platforms for EV charger management, dynamic load balancing, and billing.",
    },
    {
      title: "Intelligent Fleet Management",
      desc: "Real-time fleet tracking, AI driver safety monitoring, predictive maintenance, and route optimization.",
    },
    {
      title: "Autonomous Mobility Systems",
      desc: "High-precision HD mapping pipelines, LiDAR point-cloud processing, and V2X vehicle-to-everything communication.",
    },
  ];
  ...
  const solutions = [
    {
      id: "ev-cloud",
      title: "EV Charging Cloud OS",
      desc: "Centralized charge point management system (CPMS) with dynamic tariff pricing and smart grid integration.",
    },
    {
      id: "fleet-telemetry",
      title: "Fleet Telemetry Hub",
      desc: "Real-time asset tracking platforms processing high-frequency vehicle telemetry for commercial fleets.",
    },
    {
      id: "in-cabin",
      title: "In-Cabin Digital Cockpit",
      desc: "Intuitive infotainment UX/UI design and responsive voice-assisted vehicle control software.",
    },
    {
      id: "ride-hailing",
      title: "Micro-Mobility & Dispatch",
      desc: "Ride-hailing dispatch algorithms, scooter fleet management, and dynamic geo-fencing engines.",
    },
    {
      id: "v2x-platform",
      title: "V2X Edge Connected Mobility",
      desc: "Low-latency edge processing connecting vehicles with smart traffic lights, toll gates, and city sensors.",
    },
  ];

  const caseStudies = [
    {
      client: "Global EV Charger Network",
      title: "OCPP 2.0.1 Charge Point OS",
      desc: "Built multi-tenant EV charging network management system connecting 40,000+ public chargers globally.",
      image: "/projects/city-pulse.jpg",
    },
    {
      client: "Commercial Fleet Leader",
      title: "AI Fleet Safety & Fuel Analytics",
      desc: "Reduced fleet fuel consumption by 18% and improved safety scores across 12,000 heavy vehicles.",
      image: "/products-engineering.png",
    },
    {
      client: "Autonomous Shuttle Operator",
      title: "HD Mapping & V2X Edge Telemetry",
      desc: "Architected sub-10ms edge telemetry pipeline for self-driving urban shuttle fleets.",
        ...
        <section className="relative pt-10 pb-16 lg:pt-16 lg:pb-24 border-b border-[#e5e7eb] bg-gradient-to-b from-[#fcfdfe] via-[#f8f9fc] to-[#f2f3f6]">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs sm:text-sm text-[#484f6b] mb-8 font-medium">
              ...
              <span className="text-[#181a24] font-bold">Mobility</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <p className="text-[#484f6b] text-lg sm:text-xl leading-relaxed max-w-2xl font-normal">
                  Connected vehicle OS, EV charging infrastructure, and intelligent fleet management.
                </p>
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/60 bg-slate-100 group">
                  <Image
                    src="/mobility.png"
                    alt="Connected Mobility Systems"
                    width={700}
                    height={600}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              <div className="lg:col-span-6">
                <div className="relative rounded-3xl overflow-hidden shadow-xl border border-slate-200">
                  <Image
                    src="/mobility1.png"
                    alt="Mobility Engineering Session"
                    width={800}
                    height={700}
              ...
              <div className="lg:col-span-6 flex flex-col justify-center">
                ...
                <p className="mt-5 text-[#484f6b] text-base sm:text-lg leading-relaxed font-normal">
                  Vexus Lab works with OEMs, tier-1 suppliers, and EV infrastructure leaders to build software-defined vehicle architectures, digital cockpits, and cloud fleet management systems.
                </p>
                <div className="mt-8">
                  <Link
                    href="/contact"
