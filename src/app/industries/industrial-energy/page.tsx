...
export default function IndustrialEnergyPage() {
  ...
  const capabilities = [
    {
      ...
      desc: "Deploying SCADA integrations, PLC sensor telemetry, and edge compute nodes for real-time manufacturing optimization.",
    },
    {
      title: "IIoT Predictive Maintenance",
      desc: "Building machine learning models that analyze vibration and thermal data to prevent unscheduled equipment downtime.",
    },
    {
      title: "Renewable Energy Grid Control",
      desc: "Architecting smart grid software for solar/wind telemetry, battery storage management, and load balancing.",
    },
    {
      title: "Industrial Digital Twins",
      desc: "Creating 3D digital twin simulations of physical assets to model production scenarios and energy efficiency.",
    },
  ];
  ...
  const solutions = [
    {
      id: "smart-factory",
      title: "Smart Factory OS",
      desc: "Unified industrial IoT dashboards aggregating real-time assembly line metrics, OEE, and quality telemetry.",
    },
    {
      id: "grid-analytics",
      title: "Smart Grid Analytics",
      desc: "Predictive demand forecasting algorithms for electric utilities and renewable microgrid operators.",
    },
    {
      id: "asset-health",
      title: "Asset Health Monitoring",
      desc: "Continuous condition monitoring systems for turbines, transformers, and heavy industrial machinery.",
    },
    {
      id: "supply-telemetry",
      title: "Industrial Supply Chain",
      desc: "Track-and-trace logistics platforms linking factory outputs directly with enterprise ERP systems.",
    },
    {
      id: "sustainability",
      title: "Carbon & ESG Telemetry",
      desc: "Automated carbon footprint tracking and regulatory ESG compliance reporting for industrial enterprises.",
    },
  ];
  ...
  const caseStudies = [
    {
      ...
      title: "Grid Optimization & Telemetry Platform",
      desc: "Built high-availability grid monitoring platform handling millions of sensor telemetry events per second.",
      image: "/hero-engineering.jpg",
    },
    {
      client: "Global Industrial Manufacturer",
      title: "IIoT Predictive Maintenance System",
      desc: "Reduced factory line downtime by 32% across 14 international assembly plants.",
      image: "/products-engineering.png",
    },
    {
      client: "Renewable Microgrid Operator",
      title: "Battery Storage & Smart Load Balancing",
      desc: "Architected real-time power dispatching algorithm maximizing renewable energy utilization.",
        ...
        <section className="relative pt-10 pb-16 lg:pt-16 lg:pb-24 border-b border-[#e5e7eb] bg-gradient-to-b from-[#fcfdfe] via-[#f8f9fc] to-[#f2f3f6]">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs sm:text-sm text-[#484f6b] mb-8 font-medium">
              ...
              <span className="text-[#181a24] font-bold">Industrial &amp; Energy</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <p className="text-[#484f6b] text-lg sm:text-xl leading-relaxed max-w-2xl font-normal">
                  Smart factories, IIoT predictive maintenance, and renewable energy grid software.
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  ...
                  >
                    Start an industrial tech consultation →
                  </Link>
                  <Link
                    href="/projects"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex flex-col justify-center">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#181a24] tracking-tight leading-tight">
                  Digitizing heavy industry and power grids
                </h2>
                <p className="mt-5 text-[#484f6b] text-base sm:text-lg leading-relaxed font-normal">
                  Vexus Lab bridges physical machinery with cloud intelligence, building secure edge-to-cloud software platforms for energy utilities, manufacturing plants, and clean tech innovators.
                </p>
                <div className="mt-8">
                  <Link
                    href="/contact"
