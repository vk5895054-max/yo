...
export default function MediaEntertainmentPage() {
  ...
  const capabilities = [
    {
      title: "Low-Latency Streaming Architectures",
      desc: "Engineered sub-second latency OTT live streaming architectures with dynamic adaptive bitrate (ABR) encoding.",
    },
    {
      title: "DRM Licensing & Content Security",
      desc: "Multi-DRM integration (Widevine, FairPlay, PlayReady) and forensic digital watermarking to protect high-value video IP.",
    },
    {
      title: "Immersive Content & Spatial Computing",
      desc: "Building WebGL, AR/VR immersive media environments, 3D interactive streaming, and spatial audio integrations.",
    },
    {
      title: "AI Personalization & Recommendation Engines",
      desc: "Deploying real-time content recommendation pipelines and dynamic ad insertion (DAI) to maximize viewer engagement.",
    },
  ];
  ...
  const solutions = [
    {
      ...
      desc: "Cloud-native video ingestion, packaging, and edge CDN distribution for millions of concurrent viewers.",
    },
    {
      id: "drm-security",
      title: "Multi-DRM & Content Protection",
      desc: "Unified license key exchange servers with dynamic forensic watermarking against piracy.",
    },
    {
      id: "ai-recommendations",
      title: "AI Content Recommendation Engine",
      desc: "Personalized feed algorithms analyzing viewing history, content embeddings, and user preference vectors.",
    },
    {
      id: "live-transcoding",
      title: "Real-Time Live Transcoding",
      desc: "GPU-accelerated live video transcoding pipelines supporting 4K HDR and spatial audio.",
    },
    {
      id: "dai-monetization",
      title: "Dynamic Ad Insertion (DAI)",
      desc: "Server-side ad insertion (SSAI) seamlessly weaving personalized video ads into live and VOD streams.",
    },
  ];

  const caseStudies = [
    {
      client: "Global Broadcast Giant",
      title: "4K Ultra-Low Latency Live Streaming Platform",
      desc: "Delivered sub-1-second live sports streaming infrastructure handling 3M concurrent live viewers seamlessly.",
      image: "/projects/city-pulse.jpg",
    },
    {
      client: "Digital Content Network",
      title: "Multi-DRM Security & Anti-Piracy Architecture",
      desc: "Implemented automated DRM license issuance protecting 100,000+ premium movie and series titles.",
      image: "/products-engineering.png",
    },
    {
      client: "Music & Podcast Service",
      title: "AI Personalization & Spatial Audio Engine",
      desc: "Built contextual recommendation pipeline boosting user daily average watch/listen time by 28%.",
        ...
        <section className="relative pt-10 pb-16 lg:pt-16 lg:pb-24 border-b border-[#e5e7eb] bg-gradient-to-b from-[#fcfdfe] via-[#f8f9fc] to-[#f2f3f6]">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs sm:text-sm text-[#484f6b] mb-8 font-medium">
              ...
              <span className="text-[#181a24] font-bold">Media &amp; Entertainment</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <p className="text-[#484f6b] text-lg sm:text-xl leading-relaxed max-w-2xl font-normal">
                  Low-latency streaming architectures, DRM licensing, and immersive content delivery.
                </p>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-4">
                  ...
                  >
                    Start a media streaming consultation →
                  </Link>
                  <Link
                    href="/projects"
              ...
              <div className="lg:col-span-5 relative">
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/60 bg-slate-100 group">
                  <Image
                    src="/media.png"
                    alt="Media & Entertainment Streaming"
                    width={700}
                    height={600}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex flex-col justify-center">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#181a24] tracking-tight leading-tight">
                  Crafting high-performance media delivery
                </h2>
                <p className="mt-5 text-[#484f6b] text-base sm:text-lg leading-relaxed font-normal">
                  Vexus Lab partners with streaming platforms, broadcasters, and game studios to engineer scalable video pipelines, DRM security frameworks, and interactive immersive media experiences.
                </p>
                <div className="mt-8">
                  <Link
                    href="/contact"
