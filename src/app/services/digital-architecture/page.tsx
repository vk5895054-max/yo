...
export default function DigitalArchitecturePage() {
  ...
  const capabilities = [
    {
      ...
      desc: "Architecting loosely coupled, highly available microservices engineered for high throughput and zero-downtime deployments.",
    },
    {
      title: "Domain-Driven Design (DDD)",
      desc: "Aligning complex software boundaries with core business domain models for long-term maintainability and agility.",
    },
    {
      title: "API Gateways & Service Mesh",
      desc: "Implementing enterprise API gateways, gRPC communication, and Istio service mesh for traffic management and observability.",
    },
    {
      title: "Real-time Event Streaming",
      desc: "Leveraging Apache Kafka, RabbitMQ, and AWS EventBridge to enable asynchronous event-driven data processing.",
    },
  ];
  ...
  const solutions = [
    {
      ...
      desc: "Create a single source of truth to help your team and partners deliver seamless, consistent digital experiences at every touchpoint.",
    },
    {
      id: "product-strategy",
      title: "Product Strategy",
      desc: "Start with strategy to validate product-market fit, accelerate transformation, and ensure long-term success.",
    },
    {
      id: "ux-ui-design",
      title: "Product & UX/UI Design",
      desc: "User wireframes, user flows, sitemaps, component libraries, and more to design the product experience.",
    },
    {
      id: "innovation-prototyping",
      title: "Innovation & Rapid Prototyping",
      desc: "Refine concepts, reduce risks, and bring market-ready products to users faster with realistic functional specs.",
    },
    {
      id: "launch-adoption",
      title: "Product Launch & Adoption",
      desc: "Prepare a smooth launch and drive adoption by partnering on change management and strategic launch plans.",
    },
  ];
  ...
  const caseStudies = [
    ...
    {
      client: "Cegid SaaS",
      title: "Enterprise SaaS Cloud Optimization",
      desc: "Accelerated cloud platform performance and redesigned unified architecture for enterprise software.",
      image: "/products-engineering.png",
    },
    {
      client: "Ben & Jerry's",
      title: "Global DTC & Digital Commerce",
      desc: "Transformed digital customer engagement with personalized ordering and reward platforms.",
        ...
        <section className="relative pt-10 pb-16 lg:pt-16 lg:pb-24 border-b border-[#e5e7eb] bg-gradient-to-b from-[#fcfdfe] via-[#f8f9fc] to-[#f2f3f6]">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
            <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-xs sm:text-sm text-[#484f6b] mb-8 font-medium">
              ...
              <span className="text-[#181a24] font-bold">Digital Product Architecture</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <p className="text-[#484f6b] text-lg sm:text-xl leading-relaxed max-w-2xl font-normal">
                  Enterprise architecture, scalable microservices, and digital execution tailored for high-availability systems.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 flex flex-col justify-center">
                ...
                <p className="mt-5 text-[#484f6b] text-base sm:text-lg leading-relaxed font-normal">
                  Vexus Lab helps global brands across industries design and build what&apos;s next: understanding customer needs, discovering new opportunities, accelerating time to market, and driving digital transformation.
                </p>
                <div className="mt-8">
                  <Link
                    href="/contact"
